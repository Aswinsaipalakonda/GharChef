...
export const MOCK_PRODUCTS: BakeProduct[] = [
  ...
  {
    id: "bhb-05",
    name: "Pure Jaggery Ragi Chocolate Brownie",
    slug: "jaggery-ragi-chocolate-brownie",
    description: "Fudgy, rich chocolate brownies made with finger millet (Ragi) flour, organic dark cocoa, and unrefined palm jaggery.",
    ingredients: ["Ragi Flour", "Organic Jaggery", "Pure Cow Ghee", "Dark Cocoa 70%", "Walnuts"],
    price: 399,
    mrp: 520,
    weight: "350g",
    weightOptions: ["350g", "700g"],
    rating: 4.9,
    reviewsCount: 112,
  ...
  {
    id: "bhb-06",
    name: "Cardamom & Cashew Whole Wheat Rusk",
    slug: "cardamom-cashew-wheat-rusk",
    description: "Double-baked crispy teatime rusks prepared with whole wheat, green cardamom, and toasted cashew nuts.",
    ingredients: ["Whole Wheat Flour", "Organic Jaggery", "Pure Desi Ghee", "Cashew Nuts", "Cardamom"],
    price: 199,
    mrp: 260,
    weight: "300g",
  ...
  {
    id: "bhb-07",
    name: "Organic Honey & Sesame Millet Crunch",
    slug: "honey-sesame-millet-crunch",
    description: "Bite-sized crunchy sesame & millet bars sweetened with pure wild forest honey and organic jaggery.",
    ingredients: ["Foxtail Millet", "White Sesame Seeds", "Organic Honey", "Jaggery", "Pure Cow Ghee"],
    price: 279,
    mrp: 350,
    weight: "250g",
    weightOptions: ["250g", "500g"],
  ...
  {
    id: "bhb-08",
    name: "Jaggery Coconut & Jowar Cookies",
    slug: "jaggery-coconut-jowar-cookies",
    description: "Fragrant coconut cookies crafted from Sorghum (Jowar) millet flour and freshly grated desiccated coconut.",
    ingredients: ["Jowar Flour", "Desiccated Coconut", "Organic Jaggery", "Pure Desi Ghee"],
    price: 289,
    mrp: 360,
    weight: "250g",
    weightOptions: ["250g", "500g"],
